...
namespace DemiAPI.Migrations
{
    ...
    [Migration("20211221014712_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemiAPI.Models.Album", b =>
                {
                    ...
                    b.HasIndex(new[] { "AlbumArtistId" }, "IX_Albums_Album_Artist_Id");
            ...
            modelBuilder.Entity("DemiAPI.Models.Artist", b =>
                {
                    ...
                    b.HasIndex(new[] { "ArtistGenreId" }, "IX_Artists_Artist_genre_id");
            ...
            modelBuilder.Entity("DemiAPI.Models.Album", b =>
                {
                    b.HasOne("DemiAPI.Models.Artist", "AlbumArtist")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("DemiAPI.Models.Artist", b =>
                {
                    b.HasOne("DemiAPI.Models.Genre", "ArtistGenre")
                        .WithMany("Artists")
